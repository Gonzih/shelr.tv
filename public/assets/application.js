...
(function() {
  ...
  Shelr.Views.Comments.Form = (function(_super) {

    __extends(Form, _super);

    function Form() {
      this.clear = __bind(this.clear, this);
      this.displayComment = __bind(this.displayComment, this);
    ...
    Form.prototype.initialize = function(form) {
      Form.__super__.initialize.apply(this, arguments);
      this.el = form;
      this.el.bind('ajax:success', this.displayComment);
      return this.el.bind('ajax:error', this.handleError);
    };

    Form.prototype.handleError = function(e, xhr, status, error) {
      return console.log("error json: " + xhr.responseText);
    };

    Form.prototype.displayComment = function(e, data, status, xhr) {
      var tpl;
      this.el.find('textarea').val("");
      tpl = $('.comment-template').clone();
      tpl.removeClass('hidden').removeClass('comment-template');
      tpl.find('.body').html(data.body);
      return $('.comments').append(tpl);
    };
...
(function() {
  ...
  jQuery(function() {
    return new Shelr.Views.Comments.Form($('.comment-form form'));
  });
